class Content::HeritagesAttributes < ActiveRecord::Base
  attr_accessible :content_heritage_id, :content_attribute_id, :value
  
  validates :name, presence: true
  
  belongs_to :obj_heritage, inverse_of: :list_heritage_attributes, :class_name => 'Content::Heritage', :foreign_key => 'attribute_id'
